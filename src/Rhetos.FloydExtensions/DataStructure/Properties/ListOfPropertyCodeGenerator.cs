...
namespace Rhetos.FloydExtensions.DataStructure.Properties
{
    ...
    public class ListOfPropertyCodeGenerator : ITypeScriptGeneratorPlugin
    {
        ...
        {info.Name}?: {info.PropertyStructure.Module.Name}.{info.PropertyStructure.Name}[];", DataStructureCodeGenerator.MembersTag, info.DataStructure);
            ...
            codeBuilder.InsertCode($@"\""{info.Name}\"": {{ \""type\"": \""ListOf\"",  \""keyOfComplexMember\"": \""{info.PropertyStructure.Module.Name}/{info.PropertyStructure.Name}\""}}", DataStructureCodeGenerator.PropertiesMetaDataTag, info.DataStructure);
        }
    }
}